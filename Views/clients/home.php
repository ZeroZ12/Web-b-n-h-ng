                ...
                <div class="relative">
                    <div class="swiper <?= $section['swiperClass'] ?>">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide bg-white p-4 rounded-xl shadow hover:shadow-md transition">
                                ...
                                <h3 class="text-md font-semibold mb-2 line-clamp-2 hover:text-red-600 transition">
                    ...
                    <!-- Navigation buttons -->
                    <button class="swiper-button-prev swiper-nav-btn hidden md:flex items-center justify-center w-10 h-10 rounded-full bg-white shadow-md absolute top-1/2 -left-5 transform -translate-y-1/2 z-10 hover:bg-gray-100">
                        <!-- <i class="fas fa-chevron-left text-gray-600"></i> -->
                    </button>
                    <button class="swiper-button-next swiper-nav-btn hidden md:flex items-center justify-center w-10 h-10 rounded-full bg-white shadow-md absolute top-1/2 -right-5 transform -translate-y-1/2 z-10 hover:bg-gray-100">
