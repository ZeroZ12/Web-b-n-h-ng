        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="lg:w-80 flex-shrink-0">
                <div class="bg-white rounded-lg shadow-md p-6 sticky top-6">
                    ...
                    <button type="button" onclick="location.href='<?= ROOT_URL . '?ctl=view-check' ?>'"
                        class="w-full py-3 bg-gradient-to-r from-red-500 to-red-700 text-white rounded-lg hover:from-red-600 hover:to-red-800 transition-all duration-300 shadow-lg transform hover:scale-105 font-bold text-center"
